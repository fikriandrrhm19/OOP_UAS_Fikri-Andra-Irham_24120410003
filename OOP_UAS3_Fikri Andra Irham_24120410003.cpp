...
class PlayerFactory : public PersonFactory {
    public:
        Person* createPerson(map<string, string>& details) const override {
            return new Player(details["id"], details["firstName"], details["lastName"], details["dob"], details["nation"], stoi(details["jerseyNumber"]), details["position"]);
        }
    };
...
class StaffFactory : public PersonFactory {
    public:
        Person* createPerson(map<string, string>& details) const override {
            return new Staff(details["id"], details["firstName"], details["lastName"], details["dob"], details["nation"], details["department"], details["role"]);
        }
    };
